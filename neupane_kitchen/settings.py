"""
Django settings for neupane_kitchen project.
...
ROOT_URLCONF = 'neupane_kitchen.urls'
...
if 'USE_AWS' in os.environ:
    # Bucket Config
    AWS_STORAGE_BUCKET_NAME = 'neupane-kitchen'
...
if 'DEVELOPMENT' in os.environ:
    DEFAULT_FROM_EMAIL = 'neupanekitchen@onlinefood.com'
    ...
    DEFAULT_EMAIL_ADDRESS = os.environ.get('EMAIL_HOST_USER')
